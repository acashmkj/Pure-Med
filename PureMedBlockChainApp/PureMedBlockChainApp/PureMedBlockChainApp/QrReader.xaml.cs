        ...
        private async void ScanQrCodeButton_Clicked(object sender, EventArgs e)
        {
            ...
            ScannerPage.OnScanResult += (result) => {
                ...
                Device.BeginInvokeOnMainThread(async () => {
                    ...
                    {
                        string url = "http://PureMedblockchain.acashmkj.me/BlockChain/CheckTransactionID";
                            ...
                            try
                            {
                                ...
                                if (response.IsSuccessStatusCode)
                                {
                                    ...
                                    if (myContent == "True")
                                    {
                                        await Task.Run(async () =>
                                        {
                                            string url2 = "http://PureMedblockchain.acashmkj.me/BlockChain/GetBlockChain";
                                                ...
                                                try
                                                {
                                                    ...
                                                    if (response.IsSuccessStatusCode)
                                                    {
                                                        var myContent2 = await response2.Content.ReadAsStringAsync();
                                                        {
                                                            ...
                                                            {
                                                                BlockChain PureMedBlockChain = new BlockChain();
                                                                PureMedBlockChain.Chain = JsonConvert.DeserializeObject<List<Block>>(myContent2);
